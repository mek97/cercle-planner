  ...
  return (
    <AnimatePresence>
      {count > 0 && (
        <motion.a
          href="#schedule"
          className="fixed bottom-7 right-7 z-[60] inline-flex items-center gap-3 px-5 py-3.5 rounded-full text-black font-medium text-sm tracking-[0.01em] transition-transform hover:-translate-y-0.5"
          style={{
